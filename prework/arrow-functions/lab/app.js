...
// 'this' will refer to any variable within the brackets which is not exist (undefined).
// 2. What is "this" when joe.scopeArrow() is invoked?
// 'this' will refer to the window object.
// 3. Explain why "this" is different when an arrow function is used.
// 'this' in arrow functions look within its enclosing scope, not to the window scope.
